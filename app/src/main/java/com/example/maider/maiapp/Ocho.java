...
public class Ocho extends Fragment {
    ...
    private static final String TAG = "FragmentOcho";
    TextView scrollable;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView title = (TextView)view.findViewById(R.id.txtAcertijo4);
        title.setText(R.string.acertijo4);
        scrollable = (TextView) view.findViewById(R.id.txtAcertijo4);
        scrollable.setMovementMethod(new ScrollingMovementMethod());
        title.setTypeface(font);
        rp1 = (EditText)view.findViewById(R.id.numero);

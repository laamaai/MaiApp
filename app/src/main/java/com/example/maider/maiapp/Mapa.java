...
public class Mapa extends Fragment implements OnMapReadyCallback,
    ...
    public void onCreate(Bundle savedInstanceState, LayoutInflater inflater, ViewGroup container) {
        ...
        Normal = (ImageButton) view.findViewById(R.id.btnMapaNormal);
        Satelite = (ImageButton) view.findViewById(R.id.btnMapaSatelite);
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(getContext(), "Se encuentra a una distancia de: " + distance + "m",

...
public class cuatro3 extends Fragment {
    Button IrMapa;
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        getActivity().setRequestedOrientation(SCREEN_ORIENTATION_PORTRAIT);
        View view = inflater.inflate(R.layout.fragment_cuatro3, container, false);
        ...
        title.setText(getResources().getString(R.string.pista3));
